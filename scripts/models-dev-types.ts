/**
 * Local schema mirror for models.dev API schema.
 *
 * Upstream URL: https://raw.githubusercontent.com/anomalyco/models.dev/dev/packages/sdk/src/types.ts
 * Fetched date: 2026-07-25
 *
 * WARNING: This is a hand-written mirror to avoid adding @opencode-ai/models as a runtime dependency.
 * If upstream schema drifts, update this file and verify with `npm run sync-models:check`.
 *
 * Covered by root tsconfig.json via include pattern.
 */

/** Opaque model family identifier generated upstream. */
